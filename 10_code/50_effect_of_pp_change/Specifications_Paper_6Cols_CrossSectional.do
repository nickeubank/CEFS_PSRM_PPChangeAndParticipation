...
eststo `estimate':	xi:		areg ${dv1} ${iv1} ${iv2} ${iv3} ${controls_crosssection} ///
...
eststo `estimate':	xi:		areg ${dv1} ${iv1} ${iv2} ${iv3} ${controls_crosssection} ///
									if  ${year2}, vce(cl ${cluster2}) a(${absorb})
...
eststo `estimate':	xi:		areg ${dv2} ${iv1} ${iv2} ${iv3} ${controls_crosssection} ///
									if  ${year1}, vce(cl ${cluster2}) a(${absorb})
...
eststo `estimate':	xi:		areg ${dv3} ${iv1} ${iv2} ${iv3} ${controls_crosssection} ///
									if  ${year1}, vce(cl ${cluster2}) a(${absorb})
...
*-----------------------
	...
	esttab
		...
		using "${filename}_wcontrols.tex",
			b(a2) label replace nogaps compress se(a2) bookt
			noconstant nodepvars star(* 0.1 ** 0.05 *** 0.01)
			fragment keep(${iv1} ${iv2} ${iv3} ${controls_crosssection})
