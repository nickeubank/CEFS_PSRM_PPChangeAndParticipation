...
eststo `estimate':	xi:		areg ${dv1} ${iv1} ${iv2}   ${controls_panel} ${interaction_fe} i.year 			///
								, vce(cl ${cluster1})  absorb(${absorb})
...
eststo `estimate':	xi:		areg ${dv2} ${iv1} ${iv2}   ${controls_panel} ${interaction_fe} i.year 			///
								, vce(cl ${cluster1})  absorb(${absorb})
...
eststo `estimate':	xi:		areg ${dv3} ${iv1} ${iv2}  ${controls_panel} ${interaction_fe} i.year 			///
								, vce(cl ${cluster1})  absorb(${absorb})
...
*-----------------------
	...
	esttab
		...
		using "${filename}_wcontrols.tex",
			b(a2) label replace nogaps compress se(a2) bookt
			noconstant nodepvars star(* 0.1 ** 0.05 *** 0.01)
			fragment keep(${iv1} ${iv2}   ${controls_panel}  )
