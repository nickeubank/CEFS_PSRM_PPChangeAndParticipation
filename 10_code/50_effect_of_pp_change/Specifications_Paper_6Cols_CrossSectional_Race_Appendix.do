...
eststo `estimate':	xi:		areg ${dv1} ${iv1}   ${controls_cross_sectional_race} ///
...
eststo `estimate':	xi:		areg ${dv2} ${iv1}   ${controls_cross_sectional_race} ///
									if  ${year1}, vce(cl ${cluster2}) a(${cluster2})
...
eststo `estimate':	xi:		areg ${dv3} ${iv1}   ${controls_cross_sectional_race} ///
									if  ${year1}, vce(cl ${cluster2}) a(${cluster2})
...
*-----------------------
	...
	esttab
		...
		using "${filename}_wcontrols.tex",
			b(a2) label replace nogaps compress se(a2) bookt
			noconstant nodepvars star(* 0.1 ** 0.05 *** 0.01)
			fragment keep(${iv1}   ${controls_cross_sectional_race})
