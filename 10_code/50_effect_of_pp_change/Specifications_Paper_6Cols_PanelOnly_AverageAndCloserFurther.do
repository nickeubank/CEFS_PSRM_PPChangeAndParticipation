...
eststo `estimate':	xi:		areg ${dv1} ${iv1}  ${controls_panel} ${interaction_fe} i.year 			///
				...
				estadd local ctyearfixed	"\checkmark": `estimate'
...
*-----------------------
	...
	esttab
		...
		using "${filename}.tex",
			...
			stats(indivfixed  yearfixed ctyearfixed raceyearfixed sample N meandv stddv ,
	...
	esttab
		...
		using "${filename}_wcontrols.tex",
			...
			stats(indivfixed  yearfixed ctyearfixed sample N meandv stddv ,
				labels(	"Individual FE"
						"Year FE"
						"County x Year FE"
						"Year Sample"
